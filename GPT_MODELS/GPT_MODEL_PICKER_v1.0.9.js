...
(() => {
    ...
    function updateSelectedStatus() {
        ...
        const modeText = state.forceChatEnabled
            ? state.selectedModelSlug === config.autoModelSlug ? 'Chat Mode / Auto' : 'Chat Mode'
            : 'штатный';
    ...
    function addStyles() {
        ...
        style.textContent = `
            ...
            #gpt-model-picker-panel.is-collapsed {
                width: min(280px, calc(100vw - 16px)) !important; height: 44px !important;
                min-width: 0; min-height: 0; max-height: 44px; resize: none;
            }
